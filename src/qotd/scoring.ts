...
export const LEGACY_SCORING: ScoringConfig = { strategy: 'linear-time', version: 1, basePoints: 10, speedBonus: 2, bonusWindowSeconds: 3600 };
// Every newly finalized daily event uses flat +10; legacy configuration remains readable.
export const DEFAULT_SCORING: ScoringConfig = {...LEGACY_SCORING, speedBonus: 0};
